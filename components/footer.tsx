...
const footerLinks = {
  ...
  Resources: [
    ...
    { href: "/contact", label: "Publications" },
  ],
}
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 lg:px-8">
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div className="md:col-span-2">
            ...
            <p className="mt-4 max-w-md text-sm leading-relaxed text-primary-foreground/70">
              AI-driven drug discovery across small molecules, peptides, and
              traditional Chinese medicine. Accelerating breakthrough therapies
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-primary-foreground/10 pt-8 md:flex-row">
          <p className="text-sm text-primary-foreground/50">
            &copy; {new Date().getFullYear()} angelpro. All rights reserved.
          </p>

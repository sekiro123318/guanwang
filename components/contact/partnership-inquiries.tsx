        ...
        <div className="flex flex-col items-center gap-6 rounded-xl border border-border bg-card p-8 text-center md:flex-row md:text-left lg:p-12">
          ...
          <div className="flex-1">
            ...
            <p className="mt-2 text-muted-foreground">
              For partnership, licensing, and collaboration opportunities,
              contact our business development team directly.
            </p>
          </div>
          <a
            href="mailto:partnerships@aionlabs.ai"
